...
function draw_mouse_circle()
{
  fill(0,255,0);
  circle(mouseshapeX,mouseshapeY,15);
}

function Enemyshape1()
{
  fill(240,170,196);
...
function Enemyshape2()
{
  ...
  shape2x += shape1xspeed;  // note: should probably be shape2xspeed
  shape2y += shape1yspeed;  // note: should probably be shape2yspeed
